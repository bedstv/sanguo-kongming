...
const h=fs.readFileSync('golden-v11.html','utf8');for(const s of ['V11.5 Golden Battle','v110.css?v=11.5','v113-audio.css?v=11.5','goldenBattleV11.js?v=11.5','soundGateV11'])if(!h.includes(s))throw new Error(`golden-v11 missing ${s}`);
const css=fs.readFileSync('styles/v110.css','utf8');for(const s of ['char-liubei','char-guanyu','char-zhangfei','char-zhaoyun','char-kongming','background-size:contain!important'])if(!css.includes(s))throw new Error(`css missing ${s}`);
...
console.log('V11.5 Hero Identity Pass + fixed enemy sheets + iPhone audio validation OK');
