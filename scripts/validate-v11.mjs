...
const h=fs.readFileSync('golden-v11.html','utf8');for(const s of ['V11.2 Golden Battle','v110.css?v=11.2','goldenBattleV11.js?v=11.2','identityV11'])if(!h.includes(s))throw new Error(`golden-v11 missing ${s}`);
...
const audio=fs.readFileSync('src/v11/audioV11.js','utf8');for(const s of ['battle:','boss:','victory:','visibilitychange','pageshow'])if(!audio.includes(s))throw new Error(`audio missing ${s}`);
console.log('V11 Phase 3 validation OK');
