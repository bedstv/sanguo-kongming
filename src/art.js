const CHARS={
  liubei:{name:'劉備',main:'#2f7a52',dark:'#194831',trim:'#e1b84a',accent:'#d8e5ef',skin:'#e9bd91',hair:'#33231f',weapon:'sword',cape:'#315f49',crown:'gold',face:'calm'},
  guanyu:{name:'關羽',main:'#246c47',dark:'#163e2b',trim:'#d3aa3c',accent:'#b92f39',skin:'#d7a579',hair:'#2f1d18',weapon:'guandao',cape:'#1f5b3e',crown:'green',beard:true,face:'stern'},
  zhangfei:{name:'張飛',main:'#6d303a',dark:'#3e1d24',trim:'#d27d31',accent:'#222633',skin:'#bb865f',hair:'#17181d',weapon:'spear',cape:'#49252b',beard:true,crown:'red',face:'fierce'},
  zhaoyun:{name:'趙雲',main:'#456db4',dark:'#263f74',trim:'#e3eaf5',accent:'#73bce8',skin:'#e9c39b',hair:'#dbe7f4',weapon:'spear',cape:'#355c9c',crown:'silver',plume:'#ecf5ff',face:'heroic'},
  kongming:{name:'孔明',main:'#65509e',dark:'#392e63',trim:'#eadfc6',accent:'#83d9ff',skin:'#edc8a4',hair:'#242c3b',weapon:'fan',cape:'#4b3d7c',crown:'scholar',face:'calm'},
  scout:{name:'斥候',main:'#5d724b',dark:'#35412e',trim:'#8e6b45',accent:'#cbd5df',skin:'#c99b73',hair:'#24252a',weapon:'spear',cape:'#44533a'},
  pikeman:{name:'槍兵',main:'#6e4e44',dark:'#3f302b',trim:'#778255',accent:'#cfd8e3',skin:'#cfa17a',hair:'#23242a',weapon:'spear',cape:'#564039'},
  archer:{name:'弓手',main:'#62524a',dark:'#39312e',trim:'#637a49',accent:'#c49452',skin:'#cfa17a',hair:'#23242a',weapon:'bow',cape:'#4b403a'},
  officer:{name:'校尉',main:'#7a414c',dark:'#47272e',trim:'#3c455a',accent:'#d1d9e6',skin:'#cfa17a',hair:'#202127',weapon:'sword',cape:'#5f333c',crown:'red'},
  caoren:{name:'曹仁',main:'#405d8b',dark:'#263b5e',trim:'#d8dfea',accent:'#b48b3f',skin:'#d3a37a',hair:'#20252e',weapon:'spear',cape:'#324d78',crown:'blue',plume:'#eaf2ff',face:'stern'},
